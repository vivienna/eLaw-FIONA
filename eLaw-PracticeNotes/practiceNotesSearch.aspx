<%@ Page Language="vb" AutoEventWireup="false" Inherits="membersarea.practiceNotesSearch" CodeFile="practiceNotesSearch.aspx.vb" %>
...
<title>Practice Notes | eLaw.my</title>
        ...
        $('#txtFTS').on('change', function () {
            ...
            if (auto.length > 1)
                if (auto.length >= 2) {
                    $.ajax({
                        type: "POST",
                        url: "practiceNotesSearch.aspx/exactAutoComplete",
                        data: '{auto: "' + auto + '" }',
...
<div id="content3">
    ...
    &nbsp;<!-- Nav Tabs --><div class="clear"></div>
		<nav class="wrapperTabs">
        	...
        	<ul class="tabsBox">
            <li ><a href="formSearch.aspx">FORMS</a></li>
           
    		<li class="current1"><a href="practiceNotesSearch.aspx">PRACTICE NOTES</a></li>
 ...
 Text="Search" class="btnSave" style=" width:160px; margin-left:10px;" OnClientClick="chkformsubmit()"></asp:button>
    	    ...
    	    <tr>
    	      <td><table width="100%" border="0" cellpadding="2" cellspacing="2">
    	        <tr>
    	          <td class="style1"><span class="tTextNorm">Within : </span></td>
    	          <td width="126">

                  <asp:DropDownList ID="ddlsrch" runat="server" class="advBoxS6" ClientIDMode="Static">
                    <asp:ListItem Selected="True" Value="1">Full Documents</asp:ListItem>
       ...
       class="advBoxSfix" style="visibility:hidden; height:25px; margin:11px 0 8px 0; width:160px;" EnableViewState="False">
        ...
        <div style="text-align: center; text-transform: capitalize; font-weight: bold">
