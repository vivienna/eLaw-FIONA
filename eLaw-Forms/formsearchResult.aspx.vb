'/**********************************************************************/
'/*	Developer 	    : Modify by Mohamed Ali								   */
'/*	Company     	: The Digital Library Sdn. Bhd.		    					   */
'/* Date Modified	: 20/12/2013		        					*/  
'/*	Description		: legal Forms search result                         */
'/*	Version			: 1.0											   */
'/**********************************************************************/
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Else
                Select Case S_SortBy
                    Case 0
                        S_SortBy = " order by FORMTITLE ASC "
                        TitleSortIndex = 0

                    Case 1
                        S_SortBy = " order by FORMTITLE desc "
                        TitleSortIndex = 1
        ...
        Private Sub myBindData(ByVal sqlQuery As String)
            ...
            StrSQL = "select counting from Reference_form where  " & sqlQuery
            ...
            '///////////////////////////////////////////////////////////////////64
            StrSQL = "Select DATAFILENAME,ACTFILENAME,FORMTITLE,FORMNUMBER,COUNTRY from Reference_form where  " & sqlQuery
            CurRecForFetch = 10 * (PageCurrent - 1)
            'DT = ObjCS.ExecuteMyQuery(StrSQL)
            DT = ObjCS.ExecuteMyQuery(StrSQL, "Reference_form", CurRecForFetch)
            lblLegislationFound2.Text = "<strong><font color=#CC3300> " & RecordCount & " </font></strong>results"
            ...
            If PageCount > 0 Then
                ...
                If PageCurrent >= 1 Then
                    ...
                    For Counter = 0 To RC
                        ...
                        DataFileName = DT.Rows(Counter).Item(1)
                        DataFileName = DataFileName.Replace(".xml", "")
                        Title = DT.Rows(Counter).Item(2)
                        FORMNUMBER = DT.Rows(Counter).Item(3)
                        Dim FormNo As String = FORMNUMBER.Replace(" ", "_")
                        Dim UrlEncrptionpage As String = "id=" & DataFileName & "&No=" & FormNo
                        ...
                        Records.Append("<p class='tTitleCase'>&nbsp;<a href='FormMainDisplayed.aspx?info=" & linkpage & "'>" & Title & "</a></p>")
                        Records.Append("<p class='title2Case'> <span style='color:#f47200;font-size:14px;font-weight:700'>&nbsp;&nbsp;By " & FORMNUMBER & " </span></p>")
                        Records.Append("</div>")
...
allRecDisplayed:
            ...
            URLpage = "formsearchResult.aspx?info="
        ...
        Private Sub ddlTitle_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ddlTitle.SelectedIndexChanged
            ...
            UrlPage = "formsearchResult.aspx?ft=" & s_searchFTS & "&ns=" & s_searchNew & "&srt=" & S_SortBy & "&rc=" & S_RecordCount & "&Stype=" & S_searchType
        ...
        Private Sub NewSearch()
            ...
            End If
            UrlPage = "formsearchResult.aspx?ft=" & s_searchFTS & "&t=&an=&ns=" & s_searchNew
            UrlPage = Server.UrlPathEncode(UrlPage)
            Server.Transfer(UrlPage)
